...
class Apple(Item):
    ...
    def __init__(self):
        self.img = pygame.image.load('pictures/items/apple.png').convert_alpha()
...
class Speeder(Item):
    def __init__(self):
        self.img = pygame.image.load('pictures/items/bolt.png').convert_alpha()
...
class Slower(Item):
    def __init__(self):
        self.animation = [pygame.image.load('pictures/items/Snail/snail1.png'.format(i)) for i in range(1, 4)]
        self.animcount = 0
...
class BusterPoints(Item):
    def __init__(self):
        self.animation = [pygame.image.load(f'pictures/items/coin/01coin ({i}).png'.format(i)) for i in range(8)]
        self.animcount = 0
...
class Screamer(Item):
    def __init__(self):
        self.img = pygame.image.load('pictures/items/Skul.png').convert_alpha()
        self.img_screamer = [pygame.image.load(f'pictures/Screamer/screamer{i}.png'.format(i)) for i in range(1, 4)]
...
class Freezer(Item):
    def __init__(self):
        self.img = pygame.image.load('pictures/items/Snowflake.png').convert_alpha()
...
class Longer(Item):
    ...
    def __init__(self):
        self.animation = [pygame.image.load(f'pictures/items/RedMushroom/RedMushroom{i}.png'.format(i)) for i in range(1, 6)]
        self.animcount = 0
...
class Jewish(Item):
    def __init__(self):
        self.animation = [pygame.image.load(f'pictures/items/PurpleMushroom/PurpleMushroom{i}.png') for i in range(1, 6)]
        self.animcount = 0
...
class LifeHeart(Item):
    def __init__(self):
        self.img = pygame.image.load('pictures/items/Heart.png').convert_alpha()
...
class RockOnDefaultArea(Item):
    ...
    def __init__(self):
        self.sprites = [pygame.image.load(f'pictures/items/rocks/rock_on_default_area{i}.png') for i in range(1, 6)]
...
class RockOnBosssArea(RockOnDefaultArea):
    def __init__(self):
        self.sprites = [pygame.image.load(f'pictures/items/rocks/rock_on_boss_area{i}.png'.format(i)) for i in range(1, 6)]
