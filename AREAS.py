...
class SpeedArea(Area):
    sprite = pygame.image.load('area/speed_area.png')
    def effect(self, snake):
        snake.fps += 1000
...
class SlowArea(Area):
    sprite = pygame.image.load('area/slow_area.png')
    last_speed = 30
...
class GrowArea(Area):
    sprite = pygame.image.load('area/grow_area.png')
...
class JewishArea(Area):
    sprite = pygame.image.load('area/holy_water.png')
    def __init__(self):
