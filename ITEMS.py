...
class Apple(Item):
    ...
    def __init__(self):
        self.img = pygame.image.load('items/apple.png').convert_alpha()
...
class Speeder(Item):
    def __init__(self):
        self.img = pygame.image.load('items/bolt.png').convert_alpha()
...
class Freezer(Item):
    def __init__(self):
        self.img = pygame.image.load('items/Snowflake.png').convert_alpha()
...
class LifeHeart(Item):
    def __init__(self):
        self.img = pygame.image.load('items/Heart.png').convert_alpha()
